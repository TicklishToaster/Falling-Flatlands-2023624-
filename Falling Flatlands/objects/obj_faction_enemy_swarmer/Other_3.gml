...
////else if (point_distance(x, y, obj_faction_player.x, obj_faction_player.y) < engagement_range/4) {
...
////if (collision_circle(x, y, sprite_width/2, obj_faction_player, true, true)) {
//	motion_set(image_angle, 0);
//}
////else if (point_distance(x, y, obj_faction_player.x, obj_faction_player.y) < engagement_range/20) {
////	// Halt motion.	
////	motion_set(image_angle, 0);
////}
...
//show_debug_message(health_points)