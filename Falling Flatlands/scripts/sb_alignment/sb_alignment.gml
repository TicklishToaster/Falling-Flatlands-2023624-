...
function sb_alignment() {

	var _align_obj = argument[0];
	var _align_radius = argument[1];
	var _weight = argument[2];

	var _neighbour_list = collision_circle_list(position[1], position[2], _align_radius, _align_obj, false, true, true, true);
	...
	if(_neighbour_list != noone) { // Has neighbours
	    ...
	    //for(i=0; i<clamp(_neighbour_num, _neighbour_num, 2); i++) {
